  ...
  const [works, setWork] = useState([
    {
      ...
      discription: `YPA has taken proactive measures to address the growing
          challenges related to water scarcity and sustainable water
          management.`,
      href: "#",
    },
    {
      title: "Environment Protection",
      discription: `Founded on the belief that the youth play a pivotal role in
          shaping the future, the organization focuses on harnessing the
          energy, creativity, and passion of young individuals to address
          pressing environmental challenges.`,
      href: "#",
    },
    {
      title: "Health & Wellbeing",
      discription: `Committed to making a positive impact on the lives of the youth,
          the organization focuses on various aspects of health to empower
          and uplift communities.`,
      href: "#",
    },
    {
      title: "Youth Development",
      discription: `Recognizing the immense potential of the youth, the organization
          focuses on empowering and equipping them with the necessary
          skills, knowledge, and opportunities to thrive in various
          aspects of life.`,
      href: "#",
    },
    {
      title: "YPA Theatre",
      discription: `Street theatre, being an impactful and accessible form of
          communication, allows Youth Power Association to reach diverse
          audiences in urban and rural settings.`,
      href: "#",
    },
    {
      title: "YPA Musical Band",
      discription: `Being YPA a youth lead NGO the musical band in our organisation
          helps talented personality in providing them a platform.`,
      href: "#",
    },
  ]);
  return (
    <div>
      <section className="text-[#145589] bg-white">
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-lg text-center">
            <h2 className="text-3xl font-bona-nova-sc-bold font-bold sm:text-4xl">
              What we do ?
            </h2>
            <p className="mt-4 text-[#145589]/[0.78]">
              A youth lead organisation always active and energies to work on
              social issues, environment protection, youth development, water
              conservation and theare .
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {works.map((work, keys) => (
              ...
              >
                ...
                <h2 className="mt-4 text-xl font-bold text-[#145589]">
                  {work.title}
                </h2>

                <p className="mt-1 text-sm text-[#145589]/[0.78]">
                  {work.discription}
                </p>
              </a>
            ))}
          ...
          <div className="mt-12 text-center">
            <a
              href="/donate?type=work"
              className="cursor-pointer inline-block rounded uppercase bg-[#145589] px-12 py-3 text-sm font-medium text-white transition hover:bg-pink-700 focus:outline-none focus:ring focus:ring-yellow-400"
            >
              Donate in our Work
            </a>
          </div>
